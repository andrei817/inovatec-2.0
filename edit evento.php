...
if (isset($_GET['edit'])) {
    ...
    // Deletar entradas antigas das tabelas intermediárias
...
if (isset($_POST['atualizar'])) {
    ...
    if (!empty($_FILES['imagem']['name'])) {
        ...
        if (move_uploaded_file($_FILES['imagem']['tmp_name'], $target_file)) {
            ...
            // A string de tipos deve corresponder ao número de parâmetros
        ...
        $stmtUpdate = $conn->prepare($sqlUpdate);
        // Aqui são 15 parâmetros (sem o campo imagem)
