...
// Atualizar os eventos para remover a referência ao tema (caso você não queira excluir os eventos)
...
$stmt->bind_param("i", $id_tema); // 'i' para inteiro (id do tema)
if ($stmt->execute()) {
    //echo "<script>alert('Tema excluído com sucesso!'); window.location.href='tema lista.php';</script>";
