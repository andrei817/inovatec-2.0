...
<section class="prod-evento">
            ...
            <tbody>
                <?php while ($produtor = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td class="actions">
  <a href="edit.php?id=<?php echo $produtor['id']; ?>"> <button class='btn-edit'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
 ...
 <a href="delete prod.php?id=<?php echo $produtor['id']; ?>" onclick="return confirm('Tem certeza que deseja excluir este produtor?');">  <button class='btn-delete'> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
